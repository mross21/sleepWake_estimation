#%%
import function_sleepWakeLabels_thresholdKP as sleep
import pandas as pd
import glob
import re
...
def save_gsvds_thresholdKP(dat_dir: str, all_files: List[str], subs: List[str], out_file: str):
    """
...
if __name__ == '__main__':
    ...
    save_gsvds_thresholdKP(dat_dir, all_files, subs, out_file='gsvd_results_thresholdKP.pkl')
